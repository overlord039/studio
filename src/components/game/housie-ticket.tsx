        ...
        row.map((number, c) => {
          ...
          return (
            <div
              ...
              className={cn(
                "aspect-square flex items-center justify-center p-1 md:p-2 text-2xl md:text-3xl lg:text-4xl font-medium border border-border/50 transition-colors duration-150 ease-in-out",
